<nav class="tabs tabs--line padding-left-8 padding-right-8 tabs-step">
    <ul>
        <li class="is-completed <?php echo ($active == 1) ? 'is-active' : ''; ?>" <?php echo ($quizId > 0 && $active != 1) ? 'onclick="form(\'' . $quizId . '\');"' : ''; ?>>
            <a href="javascript:void(0)"><?php echo Label::getLabel('LBL_General'); ?>
            <span class="step-sign"></span>
        </a>
        </li>
        <li class="is-error <?php echo ($active == 2) ? 'is-active' : ''; ?>">
        ...
        <li class="is-error <?php echo ($active == 3) ? 'is-active' : ''; ?>">
