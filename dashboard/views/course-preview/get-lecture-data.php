                    ...
                    <div class="box-outlined__body">
                        <div class="lecture-attachment">
                            ...
                            foreach ($resources as $resource) { ?>
                                <a href="<?php echo MyUtility::makeUrl('CoursePreview', 'downloadResource', [$resource['lecsrc_id']]); 
                                            ?>" target="_blank" class="lecture-attachment__item">
                                    ...
                                    <span class="lecture-attachment__content">
                                        <p class="margin-bottom-0 color-black">
                                            <?php echo $resource['resrc_name']; ?>
                                        </p>
                                    </span>
                                </a><?php
                            }
