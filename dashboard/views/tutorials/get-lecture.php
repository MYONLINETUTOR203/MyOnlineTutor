        ...
        <div class="row justify-content-between">
            <div class="col-sm-6">
                <?php if (empty($video['lecsrc_link'])) { ?>
                    <a href="javascript:void(0);" id="btnComplete<?php echo $lecture['lecture_id']; ?>" onclick="markComplete('<?php echo $lecture['lecture_id']; ?>', '<?php echo AppConstant::YES; ?>')" class="btn btn--primary btn--sm-block btnCompleteJs  <?php echo (!in_array($lecture['lecture_id'], $lectures)) ? '' : 'btn--disabled' ?>">
            ...
            <div class="col-sm-auto">
                <div class="btn-actions">
                    ...
                    <?php if (!empty($quizLinkId)) { ?>
                        <a href="javascript:void(0);" onclick="openQuiz('<?php echo $quizLinkId; ?>')" class="btn btn--primary-bordered margin-left-1 quizNavJs">
