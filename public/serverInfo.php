...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>System Requirement check</title>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>32M</td>
                                    <td>32M or 32M+</td>
                                    <td class="text-center">                                            <span class="text-success"><i class="fa fa-check-circle svg-icn check"><svg class="icon icon--check"><use xlink:href="#Check_Circle" /></svg></i></span>
                                                                            </td>
                                </tr>
                                <tr>
                                    <td>PHP Version</td>
                                    <td>7.2.34</td>
                                    <td>5.5+</td>
                                    <td class="text-center">                                            <span class="text-success"><i class="fa fa-check-circle svg-icn check"><svg class="icon icon--check"><use xlink:href="#Check_Circle" /></svg>
                                                </i></span>
                                                                            </td>
                                </tr>              
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Url Rewriting (mod_rewrite) (Optional) If Off, then SEO URLs will not work.</td>
                                    <td>                                            Off                                                                            </td>
                                    <td>On</td>
                                    <td class="text-center">                                            <span class="text-danger"><i class="fa fa-minus-circle svg-icn delete"><svg class="icon icon--check"><use xlink:href="#Check_Close" /></svg></i></span>
                                                                            </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <fieldset>
                        <table class="table">
                            <thead>
                                <tr>
                                    <td width="35%"><b>Extension Settings</b></td>
                                    <td width="25%"><b>Current Settings</b></td>
                                    <td width="25%"><b>Required Settings</b></td>
                                    <td width="15%" class="text-center"><b>Status</b></td>
                                </tr>
                    ...
                    <p>3. Please make sure you have Mysql version 5.6 or greater than 5.6</p>
                    <p>4. sql_mode - strict_trans_tables should be disabled.</p>
                    <p>Note: In some server environment, script unable to detect server settings. So if you have configured your server as per required settings, You can install <a href="http://www.fatbit.com/" target="_blank">FatBit</a> Powered Scripts. </p>
                </form>
            </div>    
        </div>
    </div>
