...
ALTER TABLE `tbl_course_approval_requests`  ADD `coapre_title` VARCHAR(255) NOT NULL  AFTER `coapre_course_id`,  ADD `coapre_subtitle` VARCHAR(255) NOT NULL  AFTER `coapre_title`,  ADD `details` TEXT NOT NULL  AFTER `coapre_subtitle`,  ADD `coapre_price` VARCHAR(30) NOT NULL  AFTER `details`,  ADD `coapre_duration` INT NOT NULL  AFTER `coapre_price`;
