...
INSERT INTO `tbl_certificate_templates` (`certpl_lang_id`, `certpl_code`, `certpl_name`, `certpl_body`, `certpl_vars`, `certpl_status`, `certpl_created`, `certpl_updated`, `certpl_deleted`) VALUES
(1, 'course_evaluation_certificate', 'Course Evaluation Certificate', '{\"heading\": \"Certificate Of Evaluation\", \"learner\": \"{learner-name}\", \"trainer\": \"Tutor: {teacher-name}\", \"content_part_1\": \"This is to certify that\", \"content_part_2\": \"has successfully completed \\\"{course-name}\\\" \\\"{course-language}\\\" online course on {course-completed-date}   and has achieved {course-score} score.\", \"certificate_number\": \"Certificate No.: {certificate-number}\"}', '{learner-name} Learner name <br>\r\n{teacher-name} Teacher name <br>\r\n{course-name} Course Title <br>\r\n{course-language} Course Language<br>\r\n{course-completed-date} Course Completed On <br>\r\n{certificate-number} Certificate Number<br>\r\n{course-score} Course Score<br><br>', 1, '2022-03-15 04:00:00', '2022-11-09 12:32:05', NULL),
(2, 'course_evaluation_certificate', 'Course Evaluation Certificate', '{\"heading\": \"Certificate Of Evaluation\", \"learner\": \"{learner-name}\", \"trainer\": \"Tutor: {teacher-name}\", \"content_part_1\": \"This is to certify that\", \"content_part_2\": \"has successfully completed \\\"{course-name}\\\" \\\"{course-language}\\\" online course on {course-completed-date}   and has achieved {course-score} score.\", \"certificate_number\": \"Certificate No.: {certificate-number}\"}', '{learner-name} Learner name <br>\r\n{teacher-name} Teacher name <br>\r\n{course-name} Course Title <br>\r\n{course-language} Course Language<br>\r\n{course-completed-date} Course Completed On <br>\r\n{certificate-number} Certificate Number<br>\r\n{course-score} Course Score<br><br>', 1, '2022-03-15 04:00:00', '2022-08-23 05:06:05', NULL);
INSERT INTO `tbl_language_labels` (`label_lang_id`, `label_key`, `label_caption`) VALUES
(1, 'LBL_QUIZ_SETTINGS_NOTE', 'Note: Validity & Offer Certificate Settings are not applicable for courses.');
...
DROP TABLE IF EXISTS `tbl_two_factor_auths`;
CREATE TABLE IF NOT EXISTS `tbl_two_factor_auths` (
  `usauth_user_id` int(11) NOT NULL,
  `usauth_otp` tinyint(6) NOT NULL,
  `usauth_expiry` datetime NOT NULL,
  `usauth_browser` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `usauth_ip` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `usauth_status` tinyint(1) NOT NULL,
  `usauth_created` datetime NOT NULL,
  PRIMARY KEY (`usauth_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

ALTER TABLE `tbl_user_settings` ADD `user_2fa_enabled` TINYINT NOT NULL AFTER `user_video_link`;

ALTER TABLE `tbl_two_factor_auths` CHANGE `usauth_otp` `usauth_otp` MEDIUMINT NOT NULL;

INSERT INTO `tbl_email_templates` (`etpl_code`, `etpl_lang_id`, `etpl_name`, `etpl_subject`, `etpl_body`, `etpl_vars`, `etpl_status`, `etpl_quick_send`) VALUES
('two_factor_authentication', 1, 'Two Factor Authentication Sent to User', 'Two Factor Authentication Login', '\r\n<table width=\"600\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\">    \r\n	<tbody>        \r\n		<tr>            \r\n			<td style=\"background:#fff;padding:0 40px; text-align:center; color:#999;vertical-align:top; border-bottom:1px solid #eee;\">                \r\n				<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\">                    \r\n					<tbody>                        \r\n						<tr>                            \r\n							<td style=\"padding:20px 0;\"> \r\n                                \r\n								<h5 style=\"margin: 0;padding: 0; text-transform: uppercase; font-size: 16px;font-weight: 500;color: #333;\"></h5>                                \r\n								<h2 style=\"margin:8px 0 0;padding: 0; font-size:30px;font-weight: 700;color: {primary-color};text-align:center;\">Two Factor Authentication</h2>                            </td>                        \r\n						</tr>                    \r\n					</tbody>                \r\n				</table>            </td>        \r\n		</tr>        \r\n		<tr>            \r\n			<td style=\"background:#fff;padding:0 40px; text-align:left; color:#999;vertical-align:top; border-bottom:1px solid #eee; \">                \r\n				<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\">                    \r\n					<tbody>                        \r\n						<tr>                            \r\n							<td style=\"padding:40px 0 60px;\">                                \r\n								<h3 style=\"margin: 0 0 10px;font-size: 24px; font-weight: 500; padding: 0;color: #333;text-align:center;\">Dear {user_name}</h3>                                \r\n								<p style=\"font-size: 14px; line-height: 20px;color: #676767;\"></p>                                                                \r\n								<p style=\"font-size: 14px; line-height: 20px;color: #676767;\">Your One Time Password is {auth_code}. This password is valid for 5 mins Please do not share this password with anyone.&nbsp;</p>                                \r\n							</td>                        \r\n						</tr>                    \r\n					</tbody>                \r\n				</table>\r\n			</td>        \r\n		</tr>    \r\n	</tbody>\r\n</table>', '{user_name} - User Full Name<br>\r\n{auth_code} - Authentication Code', 1, 0),
('two_factor_authentication', 2, 'Two Factor Authentication Sent to User', 'Two Factor Authentication Login', '\r\n<table width=\"600\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\">    \r\n	<tbody>        \r\n		<tr>            \r\n			<td style=\"background:#fff;padding:0 40px; text-align:center; color:#999;vertical-align:top; border-bottom:1px solid #eee;\">                \r\n				<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\">                    \r\n					<tbody>                        \r\n						<tr>                            \r\n							<td style=\"padding:20px 0;\"> \r\n                                \r\n								<h5 style=\"margin: 0;padding: 0; text-transform: uppercase; font-size: 16px;font-weight: 500;color: #333;\"></h5>                                \r\n								<h2 style=\"margin:8px 0 0;padding: 0; font-size:30px;font-weight: 700;color: {primary-color};text-align:center;\">Two Factor Authentication</h2>                            </td>                        \r\n						</tr>                    \r\n					</tbody>                \r\n				</table>            </td>        \r\n		</tr>        \r\n		<tr>            \r\n			<td style=\"background:#fff;padding:0 40px; text-align:left; color:#999;vertical-align:top; border-bottom:1px solid #eee; \">                \r\n				<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\" align=\"center\">                    \r\n					<tbody>                        \r\n						<tr>                            \r\n							<td style=\"padding:40px 0 60px;\">                                \r\n								<h3 style=\"margin: 0 0 10px;font-size: 24px; font-weight: 500; padding: 0;color: #333;text-align:center;\">Dear {user_name}</h3>                                \r\n								<p style=\"font-size: 14px; line-height: 20px;color: #676767;\"></p>                                                                \r\n								<p style=\"font-size: 14px; line-height: 20px;color: #676767;\">Your One Time Password is {auth_code}. This password is valid for 5 mins Please do not share this password with anyone.&nbsp;</p>                                \r\n							</td>                        \r\n						</tr>                    \r\n					</tbody>                \r\n				</table>\r\n			</td>        \r\n		</tr>    \r\n	</tbody>\r\n</table>', '{user_name} - User Full Name<br>\r\n{auth_code} - Authentication Code', 1, 0);
...
UPDATE `tbl_configurations` SET `conf_val` = '{"heading": "Certificate Of Evaluation", "learner": "{learner-name}", "trainer": "Tutor:  {teacher-name}", "content_part_1": "This is to certify that", "content_part_2": "has successfully completed \\\"{course-name}\\\" \\\"{course-language}\\\" online course on {course-completed-date} and has achieved {course-score} score.", "certificate_number": "Certificate No.:  {certificate-number}"}' WHERE `conf_name` = 'CONF_COURSE_EVALUATION_CERTIFICATE_DEFAULT_CONTENT';
