                            ...
                            <div class="view-list">
                                <ul>
                                    ...
                                    <li class="view-list__item is-hurry">
                                        ...
                                        <span class="view-list__item-label"><?php $seatleft = $class['grpcls_total_seats'] - $bookedSeats; ?><?php echo str_replace('{seats}', $seatleft, Label::getLabel('LBL_HURRY_ONLY_{seats}_SEATS_LEFT')); ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
